...
/* template */
var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"head"},[_vm._v("\n    "+_vm._s(_vm.title)+"\n")])};
var __vue_staticRenderFns__ = [];

  /* style */
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-549db3d0_0", { source: ".head[data-v-549db3d0]{font-size:40px;font-weight:700}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-549db3d0";
  /* module identifier */
...
/* eslint-disable */
const Header = withInsatll(__vue_component__);
const component = {
  Header
};
...
export { Header, index as default };
